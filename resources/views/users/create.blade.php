...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('crud.users.create.usercreate') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('crud.logreg.name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('crud.logreg.email') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="role" class="form-control @error('role') is-invalid @enderror" name="role" required>
                                    ...
                                    <option value="{{ $role }}" @if(old('role') === $role) selected @endif>{{ __('crud.enums.role.'.$role) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('crud.users.create.usercreated') }}
                                </button>
                            </div>
                        </div>
                    </form>
