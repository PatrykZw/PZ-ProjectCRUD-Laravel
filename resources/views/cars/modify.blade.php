...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('crud.cars.modify.modifycar', ['make' => $car->make, 'model' => $car->model]) }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('cars.update', $car->id) }}" enctype="multipart/form-data">
                        ...
                        <label for="make" class="col-md-4 col-form-label text-md-right">{{ __('crud.cars.main.make') }}</label>
                            ...
                            <div class="col-md-6">
                                <input id="make" type="text" maxlength="500" class="form-control @error('make') is-invalid @enderror" name="make" value="{{ $car->make }}" autocomplete="make" autofocus readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="model" type="text" maxlength="500" class="form-control @error('model') is-invalid @enderror" name="model" value="{{ $car->model }}" autocomplete="model" autofocus readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="body_shape" type="text" maxlength="500" class="form-control @error('body_shape') is-invalid @enderror" name="body_shape" value="{{ $car->body_shape }}" autocomplete="body_shape" autofocus readonly>
                        ...
                        <div class="form-group row" style="display:none">
                            ...
                            <div class="col-md-6">
                                <select id="status" class="form-control @error('status') is-invalid @enderror" name="status" autofocus readonly>
